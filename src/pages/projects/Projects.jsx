  ...
  return (
    <div className='m-0 p-0 font-[Roboto]'>
        <section className='-mt-28 text-justify mb-12 md:mx-10 md:mt-24'>
            <h1 className='text-[#BDBDBD] text-[32px] -my-3 md:text-[64px] md:leading-[44px]'>Our</h1>
            <h1 className='font-bold text-[#333333] text-[32px] md:text-[64px]'>Projects</h1>
        ...
        <section className='mt-8 text-justify mb-12 md:mx-10'>
            <div className='md:flex flex-row md:items-center'>
                <div>
