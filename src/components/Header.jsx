    ...
    <div className='font-[Roboto]'>
        <header className='mb-32 md:mb-4'>
            <nav className='flex justify-between items-center w-[92%] mx-auto'>
                ...
                <div className='md:static absolute  md:min-h-fit min-h-[20vh] left-5 top-[8%] ml-20 mt-[-4.4rem] md:mt-2 md:w-auto flex items-center px-5 '>
                    <ul className='flex md:flex-row  md:items-center md:gap-[10.2vw] gap-4'>
